...
\
This infrastructure powers a suite of protocols and products, which can be integrated into existing DeFi applications:
...
3. **dSLTP Protocol** - advanced order type for DEXs allowing for CeFi-level stop-loss and take-profit orders to be executed on-chain.
4. **Liquidity Hub** - decentralized optimization layer for DEXs enabling DEXs to tap into external liquidity sources in order to provide CeFi-competitive prices on swaps.
5. **Perpetual Hub Ultra** - complete, turnkey perpetual futures platform that any trading venue can launch under its own branding.
6. **Orbs Agentic** - the execution layer between AI agents and DeFi protocols.
7. **Orbs Institutional** - institutional-grade swap infrastructure for on-chain execution.
